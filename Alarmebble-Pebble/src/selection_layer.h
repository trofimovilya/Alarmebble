...
typedef void (*SelectionLayerChangeModeCallback)(void *context);

typedef void (*SelectionLayerIncrementCallback)(int selected_cell_idx,
                                                uint8_t reapeating_count,
                                                void *context);

typedef void (*SelectionLayerDecrementCallback)(int selected_cell_idx,
                                                uint8_t reapeating_count,
                                                void *context);
...
typedef struct SelectionLayerCallbacks {
  ...
  SelectionLayerChangeModeCallback change_mode;
...
typedef struct SelectionLayerData {
  ...
  // If is_active = false the the selected cell will become invalid, and any
